...
public class InitSystem(EntityManager em, TimeManager tm) : LarkSystem {
  ...
  public override Task Init() {
    ...
    em.AddEntity(new MetadataComponent("Camera-1"), new CameraComponent() with { Active = true }, cameraTransform);
