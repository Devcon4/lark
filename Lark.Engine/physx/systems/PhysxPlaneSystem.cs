...
public class PhysxPlaneSystem(EntityManager em, PhysxManager pm, PhysxColliderManager pcm, ILogger<PhysxPlaneSystem> logger) : LarkSystem, ILarkSystemBeforeUpdate {
